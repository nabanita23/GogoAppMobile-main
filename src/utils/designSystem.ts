...
import { AppearanceMode, CurrentAppearance, DesignSystemColors, PVoid, ThemeColors } from './types';
...
const themes: Record<AppearanceMode, ThemeColors> = {
  light: {
    screen1: colors.white,
    screen2: colors.zinc100,
    button1: colors.black,
    button2: colors.orange400,
    text1: colors.slate800,
    text2: colors.slate500,
    border1: colors.gray400,
    border2: colors.gray300,
  },
  dark: {
    screen1: colors.slate950,
    screen2: colors.slate950,
    button1: colors.blue400,
    button2: colors.orange400,
    text1: colors.slate100,
    text2: colors.slate500,
    border1: colors.slate700,
    border2: colors.slate600,
  },
};
...
export const configureDesignSystem = async (): PVoid => {
  ...
  Typography.loadTypographies({
    h1: { fontSize: 24, fontFamily: 'Outfit-SemiBold', lineHeight: 24 * 1.4 },
    h2: { fontSize: 20, fontFamily: 'Outfit-Bold', lineHeight: 20 * 1.27 },
    h3: { fontSize: 16, fontFamily: 'Outfit-SemiBold', lineHeight: 16 * 1.27 },
    body: { fontSize: 15, fontFamily: 'Outfit-Regular', lineHeight: 15 * 1.34 },
    small: { fontSize: 14, fontFamily: 'Outfit-Regular', lineHeight: 14 * 1.27 },
    xSmall: { fontSize: 12, fontFamily: 'Outfit-Regular', lineHeight: 12 * 1.27 },
    xxSmall: { fontSize: 11, fontFamily: 'Outfit-Regular', lineHeight: 11 * 1.27 },
    regular: { fontFamily: 'Outfit-Regular' },
    bold: { fontFamily: 'Outfit-Bold' },
    medium: { fontFamily: 'Outfit-Medium' },
    semibold: { fontFamily: 'Outfit-SemiBold' },
  });
};
